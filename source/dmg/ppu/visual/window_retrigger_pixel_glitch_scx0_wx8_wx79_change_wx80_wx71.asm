...
; Then, WX is changed from 79 to 80 some lines after and the back to 71:
; this should exit the glitch.
...
Loop:
    ...
    ; Let 4 lines to be rendered with the glitch
    WaitScanline 16
    ...
    ; Let 4 lines to be rendered without the glitch
    WaitScanline 20
