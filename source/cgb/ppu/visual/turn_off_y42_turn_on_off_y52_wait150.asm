...
; Turn off LCD with a certain timing and check whether the next frame is cleared or not.

; Turn off LCD in the middle of the frame.
; Then turn it on and off after 10 LCD rows.
...
ENDR
    ...
    ; At this point the screen should be all cleared
