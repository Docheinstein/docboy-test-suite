...
; Perform a HDMA (HBlank) transfer, HALT, and wake up with Timer Interrupt.
; Check how many chunks are transferred.
; Event             | Mode
; -----------------------------
; HALT              | Pixel Transfer
; Wake up from HALT | Pixel Transfer
; LCD OFF           | Pixel Transfer
