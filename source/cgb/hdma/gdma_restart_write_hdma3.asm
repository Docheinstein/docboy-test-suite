...
; Perform a basic HDMA (General Purpose) transfer then write to HDMA3 and start it again.
; The transfer should continue from the previous address (HDMA3 does not reset cursor)
