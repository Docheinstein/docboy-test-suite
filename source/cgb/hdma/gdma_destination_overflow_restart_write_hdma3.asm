...
; Then write to HDMA3 and start it again.
...
EntryPoint:
    ...
    Memcmp $8200, ExpectedVramData8200, ExpectedVramData8200End - ExpectedVramData8200
    jp nz, TestFail
